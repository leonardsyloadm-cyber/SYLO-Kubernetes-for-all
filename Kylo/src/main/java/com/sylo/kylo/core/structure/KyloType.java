 ...
 * Define métodos para obtener el tamaño fijo, validar entradas y
 * serializar/deserializar.
 */
public abstract class KyloType implements java.io.Serializable {
    private static final long serialVersionUID = 1L;

    /**
     * Devuelve el tamaño fijo del tipo en bytes.
     * Si es longitud variable, devuelve -1 o lanza una excepción dependiendo del
     * uso.
     */
