...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="mainNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#bench" data-i18n="nav.performance">Rendimiento</a></li>
                    <li class="nav-item"><a class="nav-link" href="#calculadora" data-i18n="nav.calc">Calculadora</a></li>
                    <li class="nav-item"><a class="nav-link" href="#pricing" data-i18n="nav.plans">Planes</a></li>
                </ul>
            </div>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="legalCanvas"><div class="offcanvas-header p-4 border-bottom"><h4 class="offcanvas-title fw-bold text-primary" data-i18n="legal.title">Contrato de Servicios</h4><button type="button" class="btn-close" data-bs-dismiss="offcanvas"></button></div><div class="offcanvas-body p-5 legal-content">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="reg-pane">
                ...
                <div class="form-check mt-3">
                    ...
                    <label class="form-check-label small"><span data-i18n="auth.accept_terms">Acepto los</span> <a href="#" onclick="viewTermsFromReg()" data-i18n="auth.terms_link">Términos</a>.</label>
                </div>
