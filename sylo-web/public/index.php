...
<body>
    ...
    <div class="modal fade" id="successModal"><div class="modal-dialog modal-dialog-centered"><div class="modal-content border-0 p-0 overflow-hidden shadow-2xl" style="background:transparent;"><div class="terminal-window-modern" style="background: #1e1e1e; border-radius: 12px; font-family: 'Fira Code', monospace; color: #d4d4d4;"><div class="terminal-header d-flex align-items-center p-3" style="background: #2d2d2d; border-bottom: 1px solid #3e3e3e;"><div class="d-flex gap-2"><div style="width:12px;height:12px;border-radius:50%;background:#ff5f56"></div><div style="width:12px;height:12px;border-radius:50%;background:#ffbd2e"></div><div style="width:12px;height:12px;border-radius:50%;background:#27c93f"></div></div><div class="mx-auto text-muted small">root@sylo-cluster:~</div></div><div class="p-4"><h4 class="text-success fw-bold mb-4"><i class="fas fa-check-circle me-2"></i>DESPLIEGUE COMPLETADO</h4><div class="console-output mb-4" style="font-size: 0.9rem;"><div class="mb-1"><span class="text-info">❯</span> Initializing <span class="text-warning" id="s-plan"></span> Plan... <span class="text-success">OK</span></div><div class="mb-1"><span class="text-info">❯</span> Booting <span class="text-info" id="s-os"></span> Kernel... <span class="text-success">OK</span></div><div class="mb-3"><span class="text-info">❯</span> Allocating Resources... <span class="text-white">CPU: <span id="s-cpu"></span>vC | RAM: <span id="s-ram"></span>GB</span></div><div class="border-top border-secondary border-opacity-25 pt-2 mb-2"><span class="text-muted"># INSTALLED TOOLS</span><br><span id="s-tools" class="text-light fw-bold" style="color: #a5d6ff !important"></span></div><div class="border-top border-secondary border-opacity-25 pt-2"><span class="text-muted"># ACCESS CREDENTIALS</span><br><div><span class="text-danger">root@sylo:~#</span> <span id="s-cmd" class="text-white"></span></div><div><span class="text-danger">root@sylo:~#</span> pass: <span id="s-pass" class="text-warning"></span></div></div></div><div class="text-center mt-4"><a href="../panel/dashboard.php" class="btn btn-primary w-100 rounded-pill fw-bold py-2">ACCEDER AL DASHBOARD</a></div></div></div></div></div></div>
